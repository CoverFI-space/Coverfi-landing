...
function addRewardsPopUp() {
  const genre = document.querySelector(".genre__inner");
  const listWrap = genre?.querySelector(".genre__list-wrap");
  if (!genre || !listWrap) return;

  genre.querySelector("[data-coverfi-rewards-pop-up]")?.remove();

  const wrapper = document.createElement("div");
  wrapper.className = "coverfi-rewards-pop-up-wrap";
  wrapper.dataset.coverfiRewardsPopUp = "";
  wrapper.innerHTML = `
    <div data-pop-up="" data-wf--logo-pop-up--variant="right" class="pop-up coverfi-rewards-pop-up">
      <button type="button" data-pop-up-button="" aria-label="Show Sign up" class="pop-up__button">
        <span class="pop-up__button-inner coverfi-rewards-popup-inner">
          <img src=${logoSrc} viewBox="0 0 80 80" width="100%" class="pop-up__button-svg">
          </span>
      </button>
      <div class="pop-up__overlay">
        <div class="pop-up__overlay-inner">
          ...
          <div class="pop-up__overlay-content">
            <h3 class="pop-up__overlay-title u-heading-xs">Want to join the Club?</h3>
            <div class="pop-up__overlay-content-action">
              <a data-button-alt="" data-wf--button-alt--variant="small" href="${appUrl}" target="_blank" rel="noreferrer" class="button-alt w-inline-block">
                <span class="button-alt__text-wrap"><span class="button-alt__bg"></span><span class="button-alt__text-outer"><span data-button-alt-text="" class="button-alt__text">Sign-up now!</span></span></span>
  ...
  listWrap.insertAdjacentElement("afterend", wrapper);
}
...
function updateLogosAndLinks() {
  ...
  document
    .querySelectorAll(".pop-up__button-inner:not(.coverfi-nav-logo-inner):not(.coverfi-rewards-popup-inner)")
    .forEach((container) => {
