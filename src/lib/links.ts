...
export const xUrl =
  import.meta.env.VITE_COVERFI_X_URL || "https://x.com/coverfidotspace";

export const statusUrl =
  import.meta.env.VITE_COVERFI_STATUS_URL || "/status";

export const supportEmail =
  import.meta.env.VITE_COVERFI_SUPPORT_EMAIL || "support@coverfi.space";
